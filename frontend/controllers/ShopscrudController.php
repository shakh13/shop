...
/**
 * ShopscrudController implements the CRUD actions for Shops model.
 */
class ShopscrudController extends Controller
{
    /**
     * @inheritdoc
     */
