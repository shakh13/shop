...
use app\models\CountriescrudSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CountriescrudController implements the CRUD actions for Countries model.
 */
class CountriescrudController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new CountriescrudSearch();
